function onCreatePost()
	...
	makeLuaText('Credits', "Golden (Remix)\n\nSong by Fake Bambi\n\nChart by Jordan Santiago", 1250, 0, 720)
...
function onSongStart()
	doTweenAlpha('fadeIn', 'flash', 0, (240/curBpm) * 4, 'linear')
end
...
function onUpdatePost(elapsed)
	...
	setProperty('dadGroup.y', getProperty('dadGroup.y') + 2 * math.sin(curDecBeat / 4 * math.pi) * elapsed * 80)
end