function onCreatePost()
	...
	makeLuaText('Credits', "Stepless\n\nSong by BamfonduOffical\n\nChart by Jordan Santiago", 1250, 0, 720)
...
function onStepHit()
	...
	if curStep == 1024 then
		doTweenAlpha('fadeIn1', 'flash', 0.9, (60/curBpm), 'expoOut')
	end
	if curStep == 1028 then
		doTweenAlpha('fadeIn1', 'flash', 0, (60/curBpm), 'expoIn')
	end
	if curStep == 1792 then
		doTweenAlpha('fadeIn1', 'flash', 1, (480/curBpm), 'linear')
	end
end