function onCreatePost()
	makeLuaText('Credits', "Peakve and Peakbi IV\n\nSong by flareix\n\nChart by Jordan Santiago", 1250, 0, 720)
	...
	makeLuaText('Misc', "Bro died midsong :skull:", 1250, 0, 480)
	...
	for i=0, getProperty('unspawnNotes.length') - 1 do
		if getPropertyFromGroup('unspawnNotes', i, 'strumTime') >= 120180 then
...
function onStepHit()
	...
	if curStep == 256 then
		setProperty('peakveIcon.alpha', 0)
		setProperty('daveIcon.alpha', 1)
	...
	if curStep == 512 then
		setProperty('peakveIcon.alpha', 1)
		removeLuaSprite('daveIcon', true)
		doMultiColors({getIconColor('gf'), getIconColor('dad')})
		setProperty('ytWatermark.alpha', 0)
		cameraFade('camOther', 'ffffff', (50/curBpm), false, true)
	end
