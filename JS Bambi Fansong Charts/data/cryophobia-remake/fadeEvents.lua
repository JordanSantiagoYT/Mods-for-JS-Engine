function onCreatePost()
	...
	makeLuaText('Credits', "Cryophobia ('Remake')\n\nSong by That Pizza Tower Fan\n\nChart by Jordan Santiago", 1250, 0, 720)
...
function onSongStart()
	doTweenAlpha('fadeIn', 'flash', 0, (240/curBpm) * 8, 'linear')
end
...
function onStepHit()
	...
	if curStep == 2304 then
		cameraFlash('camOther', 'ffffff', 0.7)
		doTweenAlpha('fadeOut', 'flash', 1, (480/curBpm), 'linear')
	end
end