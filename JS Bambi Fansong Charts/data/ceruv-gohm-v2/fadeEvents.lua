function onCreatePost()
	...
	makeLuaText('Credits', "Ceruv gohm (V2)\n\nSong by Myraxi\n\nChart by Jordan Santiago", 1250, 0, 720)
...
function onStepHit()
	...
	if curStep == 960 then
		doTweenAlpha('fadeStuff1', 'flash', 1, (940/curBpm), 'linear')
	end
	if curStep == 1024 or curStep == 2624 then
		cameraFlash('camOther', 'ffffff', 0.7)
		setProperty('flash.alpha', 0)
	end
	if curStep == 2048 then
		doTweenAlpha('fadeStuff2', 'flash', 0.7, (240/curBpm) * 16, 'linear')
	end
	if curStep == 2304 then
		doTweenAlpha('fadeOut2', 'flash', 0, (240/curBpm) * 16, 'linear')
	end
