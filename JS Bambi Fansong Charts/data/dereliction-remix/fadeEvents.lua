function onCreatePost()
	...
	makeLuaText('Credits', "Dereliction (V2)\n\nSong by TimeLaserz & TheTrueAccount_2\n\nOG song by Hortas\n\nChart by Jordan Santiago\n\nSprites by oriiien", 1250, 0, 720)
...
function onStepHit()
	...
	if curStep == 2560 then
		doTweenAlpha('fadeOut1', 'flash', 1, (240/curBpm) * 24, 'linear')
	end
	if curStep == 3072 then
		doTweenAlpha('fadeOut1', 'flash', 0, (240/curBpm) * 28, 'linear')
	end
