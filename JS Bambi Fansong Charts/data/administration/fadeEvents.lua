function onCreatePost()
	...
	makeLuaText('Credits', "Administration\n\nSong by NoonPersoner\n\nChart by Jordan Santiago\n\nOpponent Sprites by HalfJoke/Xaura404", 1250, 0, 720)
...
function onStepHit()
	...
	if curStep == 2912 then
		doTweenAlpha('fadeOut1', 'flash', 0.6, (240/curBpm) * 8, 'linear')
	end
	if curStep == 3040 then
		doTweenAlpha('fadeOut1', 'flash', 0, (240/curBpm) * 2, 'linear')
	end
