...
function onSongStart()
	doTweenAlpha('fadeIntro', 'flash', 0, (240/curBpm) * 15, 'linear')
end
function onStepHit()
	if curStep == 256 then
	...
	if curStep == 1792 then
		doTweenAlpha('fadeOut1', 'flash', 1, (240/curBpm) * 12, 'linear')
	end
	if curStep == 2048 then
		doTweenAlpha('fadeOut1', 'flash', 0, (240/curBpm) * 12, 'linear')
	end
