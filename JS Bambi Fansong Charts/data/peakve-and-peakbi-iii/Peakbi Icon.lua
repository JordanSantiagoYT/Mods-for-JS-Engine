...
iconName = 'peakbi' --Icon name. Use the filename for the icon. (must be named "icon-bambi")
...
function onUpdatePost()
	if not hideHud then
		...
		if alphaOverride then setProperty(tagName..'.alpha', getProperty(iconUse..'.alpha')) end
	end
