...
function onStepHit()
	if curStep == 512 then
		doTweenY('creditTween', 'Credits', 250, (360/curBpm), 'expoOut')
		setProperty('flash.alpha', 0)
	end
	if curStep == 640 then
		doTweenY('creditTween', 'Credits', -420, (360/curBpm), 'expoIn')
		doTweenAlpha('ytWatermarkIn', 'ytWatermark', 0.5, (360/curBpm), 'linear')
	end
