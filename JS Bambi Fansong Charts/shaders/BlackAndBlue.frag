#pragma header
//so um, this was taken from a psych port of vs impostor v4 but the link doesnt exist anymore. this is the black and white shader but edited so that the white color is BLUE.
		...
		void main()
		{
			...
			gl_FragColor = vec4(0, 0, outColor, textureColor.a);
		}