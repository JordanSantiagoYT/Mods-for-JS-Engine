characterPath = 'characters/Ellie_Assets' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'EllieRoseeee' -- Set this to what the sprite should be named.

noteNames = {
    'Ellie Note', -- Change this to whatever your note is named in path "custom_notetypes".
...
function onCreatePost()
    setProperty('EllieRoseeee.alpha', 0);
end


function onSongStart()
doTweenAlpha('ek', 'EllieRoseeee', 1, 1, 'linear')
end
function onStepHit()
if curStep == 3391 then
doTweenAlpha('sdfa', 'EllieRoseeee', 0, 0.1, 'linear')
end
if curStep == 3920 then
doTweenAlpha('fsdd', 'EllieRoseeee', 0, 0.1, 'linear')
end
if curStep == 1431 then
doTweenAlpha('dfhvg', 'EllieRoseeee', 0, 1, 'linear')
end
if curStep == 1685 then
doTweenAlpha('ghjkghjkg', 'EllieRoseeee', 1, 0.1, 'linear')
end
end
