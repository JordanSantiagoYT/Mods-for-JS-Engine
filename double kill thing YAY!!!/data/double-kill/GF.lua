characterPath = 'characters/Playable GF V2' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'gfplay' -- Set this to what the sprite should be named.
...
function onCreatePost()
    setProperty('gfplay.alpha', 0);
end


function onSongStart()
doTweenAlpha('gf!', 'gfplay', 1, 1, 'linear')
end
function onStepHit()
if curStep == 3391 then
doTweenAlpha('gf', 'gfplay', 0, 0.1, 'linear')
end
if curStep == 1431 then
doTweenAlpha('gfg', 'gfplay', 0, 1, 'linear')
end
if curStep == 1685 then
doTweenAlpha('gfa', 'gfplay', 1, 0.1, 'linear')
end
end
