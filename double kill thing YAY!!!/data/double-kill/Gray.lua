characterPath = 'characters/gray' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'hesmurderous' -- Set this to what the sprite should be named.
...
characterOffsets = {
    ...
    -96, -94, -- Down
    -47, -23, -- Up
    -145, 24, -- Right -- i have to do this AGAIN so that when gray hits an all opps note he doesnt slide all over the place
...
function onCreatePost()
    setProperty('hesmurderous.alpha', 0);
end


function onSongStart()
doTweenAlpha('gray', 'hesmurderous', 1, 1, 'linear')
end
function onStepHit()
if curStep == 3391 then
doTweenAlpha('gra', 'hesmurderous', 0, 0.1, 'linear')
end
if curStep == 1431 then
doTweenAlpha('gr', 'hesmurderous', 0, 1, 'linear')
end
if curStep == 1685 then
doTweenAlpha('g', 'hesmurderous', 1, 0.1, 'linear')
end
end
