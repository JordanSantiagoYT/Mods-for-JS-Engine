characterPath = 'characters/player' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'gametoons' -- Set this to what the sprite should be named.
...
animPrefixes = {
    ...
    'Ashes Down', -- Down
    'Ashes Up', -- Up
    'Ashes Left', -- Right, i got lazy ok

    'GF Miss Left', -- Left (MISS)
    'GF Miss Down', -- Down (MISS)
    'GF Miss Up', -- Up (MISS)
    'GF Miss Right', -- Right (MISS)
...
function onCreatePost()
    setProperty('gasdffasdadffplay.alpha', 0);
end


function onSongStart()
doTweenAlpha('gf!asdf', 'gametoons', 1, 1, 'linear')
end
function onStepHit()
if curStep == 3391 then
doTweenAlpha('gasdff', 'gametoons', 0, 0.1, 'linear')
end
if curStep == 1431 then
doTweenAlpha('gfsgdfg', 'gametoons', 0, 1, 'linear')
end
if curStep == 1685 then
doTweenAlpha('gsdfgfa', 'gametoons', 1, 0.1, 'linear')
end
end
