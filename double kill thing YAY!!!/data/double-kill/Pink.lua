characterPath = 'characters/pink' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'pinkimp' -- Set this to what the sprite should be named.

noteNames = {
    'Pink Note', -- Change this to whatever your note is named in path "custom_notetypes".
...
characterScales = {
    0.8, -- Scale X of character
    0.8 -- Scale Y of character
}
...
function onCreatePost()
    setProperty('pinkimp.alpha', 0);
end


function onSongStart()
doTweenAlpha('pink!', 'pinkimp', 1, 1, 'linear')
end
function onStepHit()
if curStep == 3391 then
doTweenAlpha('pink', 'pinkimp', 0, 0.1, 'linear')
end
if curStep == 3920 then
doTweenAlpha('DIEBITCH', 'pinkimp', 0, 0.1, 'linear')
end
if curStep == 1431 then
doTweenAlpha('pinkgone', 'pinkimp', 0, 1, 'linear')
end
if curStep == 1685 then
doTweenAlpha('pinkappear', 'pinkimp', 1, 0.1, 'linear')
end
end
