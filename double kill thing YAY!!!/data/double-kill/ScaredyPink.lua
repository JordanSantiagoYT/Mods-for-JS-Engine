characterPath = 'characters/pretender' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'pinkimpscared' -- Set this to what the sprite should be named.
...
function onCreatePost()
    setProperty('pinkimpscared.alpha', 0);
end

function onStepHit()
if curStep == 3393 then
doTweenAlpha('pink', 'pinkimpscared', 1, 0.1, 'linear')
end
if curStep == 3920 then
doTweenAlpha('DIEBITCH', 'pinkimpscared', 0, 0.1, 'linear')
end
end
