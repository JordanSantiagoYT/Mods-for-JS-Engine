characterPath = 'characters/Reginald_Assets' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'richguy' -- Set this to what the sprite should be named.

noteNames = {
    'Reginald Note', -- Change this to whatever your note is named in path "custom_notetypes".
...
objectOrder = 3 -- Normally, values over 7 go over GF (7), Dad (8) and BF (9). (Default: 9)
...
function onCreatePost()
    setProperty('richguy.alpha', 0);
end


function onSongStart()
doTweenAlpha('graasasdfdfasdy', 'richguy', 1, 1, 'linear')
end
function onStepHit()
if curStep == 3391 then
doTweenAlpha('grffdasda', 'richguy', 0, 0.1, 'linear')
end
if curStep == 1431 then
doTweenAlpha('gfsdfdr', 'richguy', 0, 1, 'linear')
end
if curStep == 1685 then
doTweenAlpha('gsdfss', 'richguy', 1, 0.1, 'linear')
end
end
