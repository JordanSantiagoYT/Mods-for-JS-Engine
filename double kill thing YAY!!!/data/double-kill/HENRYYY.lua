characterPath = 'characters/HENRY_ASSS' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'HenrYYYYY' -- Set this to what the sprite should be named.

noteNames = {
    'Henry Note', -- Change this to whatever your note is named in path "custom_notetypes".
...
danceEveryNumBeats = 4 -- Sets which per beat will the character dance on.
...
function onCreatePost()
    setProperty('HenrYYYYY.alpha', 0);
end


function onSongStart()
doTweenAlpha('hen', 'HenrYYYYY', 1, 1, 'linear')
end
function onStepHit()
if curStep == 3391 then
doTweenAlpha('hwe', 'HenrYYYYY', 0, 0.1, 'linear')
end
if curStep == 3920 then
doTweenAlpha('hgen', 'HenrYYYYY', 0, 0.1, 'linear')
end
if curStep == 1431 then
doTweenAlpha('nfgbh', 'HenrYYYYY', 0, 1, 'linear')
end
if curStep == 1685 then
doTweenAlpha('heenryyy', 'HenrYYYYY', 1, 0.1, 'linear')
end
end
